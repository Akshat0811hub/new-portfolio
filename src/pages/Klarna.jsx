...
import readly from "../assets/klarna.avif";
  ...
  return (
    <div className={styles.companyComponent}>
      <div className={styles.companyPhoto}>
        ...
        <p>
          At Klarna, I contributed to redesigning the existing in-store
          <br></br>experience. We analyzed the current user experience to
          understand<br></br> the challenges. We improved the interaction
          design, reduced pain <br></br>points, optimized user flows, and
          minimized the steps required to <br></br>complete an in-store
          purchase.
        </p>
      </div>
